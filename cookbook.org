...
:PROPERTIES:
:source-url: https://www.budgetbytes.com/summer-vegetables-in-red-sauce/
:servings:
:prep-time:
:cook-time:
:ready-in:
...
6. Chop and add parsley, basil, cheese, salt, pepper, red wine, and optionally oregano.
7. Simmer for 30-45 minutes. If using meat, add now.
*** Notes
